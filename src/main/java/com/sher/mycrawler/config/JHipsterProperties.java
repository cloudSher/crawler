...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "mycrawler@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "mycrawler API";

        private String description = "mycrawler API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "mycrawler";
